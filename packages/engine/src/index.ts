...
export { runLineTaintRules, ehFonteDeEntrada } from "./lineTaint.ts";
...
export { analisarTestabilidade } from "./structural/cobolTestabilidade.ts";
export type { AchadoTestabilidade } from "./structural/cobolTestabilidade.ts";
