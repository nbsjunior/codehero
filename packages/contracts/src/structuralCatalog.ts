...
export const STRUCTURAL_RULES: StructuralRule[] = [
  ...
  {
    id: "HERO-ST-cobol-string-no-overflow",
    name: "CobolStringSemOnOverflow",
    message: "STRING sem ON OVERFLOW — truncamento silencioso possível (CobRA).",
    severity: "MAJOR",
    type: "VULNERABILITY",
    ...
    whyNotRegex:
      "STRING … ON OVERFLOW pode atravessar várias linhas; o nó string_statement agrega o verbo e o corpo para o teste estrutural.",
  },
  {
    id: "HERO-ST-cobol-unstring-no-overflow",
    name: "CobolUnstringSemOnOverflow",
    message: "UNSTRING sem ON OVERFLOW — trate overflow explicitamente (CobRA).",
    severity: "MAJOR",
    type: "VULNERABILITY",
    remediationEffortMin: 15,
    cwe: ["CWE-120"],
    ...
    whyNotRegex: "Mesmo motivo do STRING: o overflow clause pode ficar fora da linha do verbo.",
  },
  {
    id: "HERO-ST-cobol-alter",
    name: "CobolAlterEstrutural",
    message: "ALTER muda destino de GO TO em runtime — fluxo auto-modificável (CobRA/RAA).",
    severity: "CRITICAL",
    type: "CODE_SMELL",
  ...
  {
    id: "HERO-ST-cobol-accept",
    name: "CobolAcceptEstrutural",
    message: "ACCEPT lê input externo — valide antes de CALL/SQL/STRING (CobRA).",
    severity: "MAJOR",
    type: "VULNERABILITY",
    remediationEffortMin: 20,
    cwe: ["CWE-20"],
  ...
  {
    id: "HERO-ST-cobol-display-sensitive",
    name: "CobolDisplaySensivel",
    message: "DISPLAY de campo sensível (PASSWORD/SENHA/SECRET) — vazamento em console (CobRA).",
    severity: "CRITICAL",
    type: "VULNERABILITY",
    remediationEffortMin: 10,
    cwe: ["CWE-532"],
    ...
    whyNotRegex: "Precisa do verbo DISPLAY estruturado + token sensível no mesmo nó, não em literal de documentação.",
  },
  {
    id: "HERO-ST-0095-function-ctor-non-literal",
    name: "FunctionCtorNaoLiteral",
    message: "new Function(...) com argumento não-literal — code injection equivalente a eval.",
    severity: "CRITICAL",
    type: "VULNERABILITY",
    remediationEffortMin: 30,
    cwe: ["CWE-95"],
    ...
    spec: {
      ...
      callee: "^Function$",
      calleeUnqualified: true,
      argument: { index: "last", is: "non-literal" },
    },
    whyNotRegex: "`new Function('return 1')` é seguro; `new Function(code)` não — só o tipo do argumento separa.",
  },
  {
    id: "HERO-ST-0079-document-write-non-literal",
    name: "DocumentWriteNaoLiteral",
    message: "document.write/writeln com valor não-literal — sink clássico de DOM XSS.",
    severity: "CRITICAL",
    type: "VULNERABILITY",
    remediationEffortMin: 25,
    cwe: ["CWE-79"],
    ...
    spec: {
      match: "call",
      callee: "^(write|writeln)$",
      argument: { index: 0, is: "non-literal" },
      textMatches: "(?i)document\\.write",
    },
    whyNotRegex: "write( pode ser stream.write; textMatches exige document.write e argumento não-literal.",
  },
  {
    id: "HERO-ST-0095-settimeout-string",
    name: "SetTimeoutString",
    message: "setTimeout/setInterval com string — equivale a eval atrasado.",
    severity: "CRITICAL",
    type: "VULNERABILITY",
    remediationEffortMin: 20,
    cwe: ["CWE-95"],
    ...
    spec: {
      ...
      argument: { index: 0, is: "literal", matches: "^['\"`]" },
    },
    whyNotRegex: "setTimeout(fn) é OK; setTimeout('code') é string — a árvore classifica o 1º argumento.",
  },
];
