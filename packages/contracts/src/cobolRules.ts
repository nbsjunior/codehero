...
export const COBOL_CORE_RULES: HeroRule[] = (
  [
    ...
    // --- CobRA / cobol-minimal-sast inspired (Presence Fase 3) ---
    {
      id: "HERO-SEC-cobol-accept-unvalidated",
      name: "CobolAcceptUnvalidated",
      languages: ["cobol"],
      severity: "MAJOR",
      type: "VULNERABILITY",
      remediationEffortMin: 20,
      ...
      owasp: ["A03:2021-Injection"],
      message:
        "ACCEPT de input externo sem validação na mesma linha — sanitize/valide antes de usar em CALL/SQL/STRING.",
      sddTemplateId: "sdd.generic.validate-input",
      category: "security-misconfiguration",
      pattern: {
        regex: "(?i)\\bACCEPT\\s+[A-Z0-9-]+(\\s+FROM\\s+\\w+)?",
        unless: "(?i)(IF\\s+|EVALUATE\\s+|INSPECT\\s+)",
      },
    },
    {
      id: "HERO-SEC-cobol-string-no-overflow",
      name: "CobolStringNoOnOverflow",
      languages: ["cobol"],
      severity: "MAJOR",
      type: "VULNERABILITY",
      remediationEffortMin: 15,
      cwe: ["CWE-120"],
      owasp: [],
      message: "STRING sem ON OVERFLOW — risco clássico de truncamento/overflow em COBOL (CobRA).",
      sddTemplateId: "sdd.generic.smell",
      category: "security-misconfiguration",
      pattern: {
        regex: "(?i)\\bSTRING\\b",
        unless: "(?i)ON\\s+OVERFLOW",
      },
    },
    {
      id: "HERO-SEC-cobol-unstring-no-overflow",
      name: "CobolUnstringNoOnOverflow",
      languages: ["cobol"],
      severity: "MAJOR",
      type: "VULNERABILITY",
      remediationEffortMin: 15,
      cwe: ["CWE-120"],
      owasp: [],
      message: "UNSTRING sem ON OVERFLOW — trate overflow explicitamente.",
      sddTemplateId: "sdd.generic.smell",
      category: "security-misconfiguration",
      pattern: {
        regex: "(?i)\\bUNSTRING\\b",
    ...
    {
      id: "HERO-SEC-cobol-dynamic-filename",
      name: "CobolDynamicFileName",
      languages: ["cobol"],
      severity: "MAJOR",
      type: "VULNERABILITY",
      remediationEffortMin: 25,
      ...
      message: "ASSIGN TO variável / nome dinâmico de arquivo — valide path e permissões (CobRA).",
      sddTemplateId: "sdd.path.validate",
      category: "path-traversal",
      pattern: {
        regex: "(?i)\\bASSIGN\\s+TO\\s+[A-Z][A-Z0-9-]*\\b",
        unless: "(?i)ASSIGN\\s+TO\\s+['\"]",
      },
    },
    {
      id: "HERO-SMELL-cobol-alter",
      name: "CobolAlterParagraph",
      languages: ["cobol"],
      severity: "CRITICAL",
      type: "CODE_SMELL",
      remediationEffortMin: 40,
      cwe: ["CWE-1120"],
      owasp: [],
      message: "ALTER ... TO PROCEED TO — fluxo auto-modificável; proibido em shops modernos.",
      sddTemplateId: "sdd.smell.remove-goto",
      category: "code-smell",
      pattern: {
        regex: "(?i)\\bALTER\\s+[A-Z0-9-]+\\s+TO\\s+(PROCEED\\s+TO\\s+)?[A-Z0-9-]+",
      },
    },
    {
      id: "HERO-SEC-cobol-display-password",
      name: "CobolDisplaySensitive",
      languages: ["cobol"],
      severity: "CRITICAL",
      type: "VULNERABILITY",
      remediationEffortMin: 10,
      ...
      message: "DISPLAY de campo com nome sensível (PASSWORD/SENHA/SECRET) — vazamento em console/log.",
      sddTemplateId: "sdd.secret.remove-log",
      category: "sensitive-data",
      pattern: {
        regex: "(?i)\\bDISPLAY\\s+.*\\b(PASSWORD|SENHA|SECRET|TOKEN|API-?KEY)\\b",
      },
    },
    {
      id: "HERO-SMELL-cobol-next-sentence",
      name: "CobolNextSentence",
      languages: ["cobol"],
      severity: "MINOR",
      type: "CODE_SMELL",
      ...
      cwe: [],
      owasp: [],
      message: "NEXT SENTENCE — estilo obsoleto; use END-IF / CONTINUE estruturado.",
      sddTemplateId: "sdd.generic.smell",
      category: "code-smell",
      pattern: {
        regex: "(?i)\\bNEXT\\s+SENTENCE\\b",
